...
| **Functional total** | 8 feature files | **45 (1 skipped)** | Behaviour-level functional coverage |
| **Playwright total** | Functional plus smoke | **46 (1 skipped)** | Adds one standalone PDF-readiness contract |
