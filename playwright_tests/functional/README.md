...
| Office document conversion | `officeConversion.spec.ts` | 9 | Five supported-format conversion requests (Word, Excel, PowerPoint, text and RTF), returned-PDF rendering, HTTP 400/500 failure propagation, timeout handling and malformed-PDF handling using deterministic document-assembly responses. |
