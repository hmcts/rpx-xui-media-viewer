...
| **Functional total** | 12 feature files | **66 (1 skipped)** | Behaviour-level functional coverage |
| **Playwright total** | Functional plus smoke | **67 (1 skipped)** | Adds one standalone PDF-readiness contract |
