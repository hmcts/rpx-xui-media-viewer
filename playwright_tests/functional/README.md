...
| **Functional total** | 12 feature files | **65 (1 skipped)** | Behaviour-level functional coverage |
| **Playwright total** | Functional plus smoke | **66 (1 skipped)** | Adds one standalone PDF-readiness contract |
