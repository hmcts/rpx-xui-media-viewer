...
| Bookmarks | `bookmarks.spec.ts` | 13 | Playwright covers highlight-origin and panel creation, update, delete/sibling promotion, single and multiple empty drafts, sorting, rendered drag-reorder persistence, and bulk lifecycle. |
